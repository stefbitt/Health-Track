...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link" href="#vamos-comecar">
                        Vamos começar
                    </a>
                    <a class="nav-item nav-link" href="#cards-group">
    ...
    <div class="row">
        ...
        <div id="carouselExampleControls" class="carousel slide col-md-12 col-sm-12" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="./assets/images/carrocel00.png" alt="Primeiro Slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="./assets/images/carrocel01.png" alt="Segundo Slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="./assets/images/carrocel02.png" alt="Terceiro Slide">
                </div>
            </div>
    ...
    <div class="row contact" id="contact">
        <form class="form-message col-xl-4 col-md-4 col-sm-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-12 col-sm-12 phone">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Opcional">
                </div>
            </div>
            <div class="form-row">
        ...
        <div class="image-contact col-xl-7 col-md-7 col-sm-6">
            <img src="./assets/images/image-contact.png" class="img" alt="image-contact">
        </div>
    ...
    <footer class="footer">
        <div class="footer-bar">
            ...
            <p class="text-footer">HealthTrack 2020 - Todos os direitos reservados.</p>
        </div>
    </footer>
    </div>
